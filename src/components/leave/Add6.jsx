...
const Add6 = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`https://fatp-api.onrender.com/api/leave5/add`, leave, {
                headers: {
            ...
            if (response.data.success) {
                navigate(`/employee-dashboard/leaves5/${user._id}`);
            }
        } catch (error) {
    ...
    return (
        <div className='max-w-4xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md'>
            <h2 className='text-2xl font-bold mb-6'>DAILY MAINTENANCE CHECKLIST KEY WRITE TESTER</h2>
            ...
            <form onSubmit={handleSubmit}>
                <div className='flex flex-col space-y-4'>
                    ...
                    <h3 className='text-lg font-bold cursor-pointer mt-4 p-2 border border-teal-500 bg-teal-100 rounded' onClick={() => setShowRawMaterialStorage(!showRawMaterialStorage)}>
                        DAILY MAINTENENCCE CHECKLIST KEY WRITE TESTER
                    </h3>
