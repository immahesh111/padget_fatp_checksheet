...
const Detail10 = () => {
    ...
    useEffect(() => {
        const fetchLeave = async () => {
            try {
                const response = await axios.get(`https://fatp-api.onrender.com/api/leave10/detail/${id}`, {
                    headers: {
    ...
    const changeStatus = async (id, status) => {
        try {
            const response = await axios.put(`https://fatp-api.onrender.com/api/leave10/${id}`, { status, approver: selectedApprover }, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('token')}`
                }
            });
            ...
            if (response.data.success) {
                ...
                navigate('/admin-dashboard/leaves10');
            }
        } catch (error) {
            if (error.response && !error.response.data.success) {
                alert(error.response.data.error);
                        ...
                        <div className='flex flex-col space-y-4'>
                            ...
                            {leave.rawMaterialStorage && (
                                <div className="border-t border-b pt-4 pb-4">
                                    <h3 className="text-lg font-bold mb-4">DAILY MAINTENANCE CHECKLIST RF TESTER</h3>
                                    <table className="min-w-full border-collapse border border-gray-300">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-gray-300 p-2 text-center">Instrument and shield box</td>
                                            ...
                                            <tr>
                                                <td className="border border-gray=300 p=2 text-center">Change</td>
                                                <td className="border border-gray=300 p=2 text-center">Check the RF cable connection condition bend or loose connection</td>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-gray=300 p=2 text-center">Check the coupler position and decvice seating without movement</td>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-gray=300 p=2 text-center">Check the correct script selected according model requirements</td>
                                                <td className="border border-gray=300 p=2 text-center">No abnormalities</td>
                                                <td className="border border-gray=300 p=2 text-center">Visual</td>
                                                <td className="border border-gray-300 p-2 text-center">NA</td>
                                                <td className="border border-gray=300 p=2 text-center">
