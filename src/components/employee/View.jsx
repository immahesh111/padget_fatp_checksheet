...
const View = () => {
    ...
    useEffect(() => {
        const fetchEmployee = async () => {
            ...
            try {
                const response = await axios.get(`https://fatp-api.onrender.com/api/employee/${id}`,
                    {
                        headers: {
    ...
    return (
        ...
        <div className='max-w-3xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                <div>
                    <img src={`https://fatp-api.onrender.com/${employee.userId.profileImage}`} className='rounded-full border w-72'></img>
                </div>
