...
const Add11 = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`https://fatp-api.onrender.com/api/leave10/add`, leave, {
                headers: {
            ...
            if (response.data.success) {
                navigate(`/employee-dashboard/leaves10/${user._id}`);
            }
        } catch (error) {
    ...
    return (
        <div className='max-w-4xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md'>
            <h2 className='text-2xl font-bold mb-6'>DAILY MAINTENANCE CHECKLIST RF TESTER</h2>
            ...
            <form onSubmit={handleSubmit}>
                <div className='flex flex-col space-y-4'>
                    ...
                    DAILY MAINTENANCE CHECKLIST RF TESTER
                    </h3>
