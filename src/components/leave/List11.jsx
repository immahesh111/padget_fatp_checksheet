...
const List11 = () => {
    ...
    const fetchLeaves = async () => {
        try {
            const response = await axios.get(`https://fatp-api.onrender.com/api/leave10/${id}/${user.role}`, {
                headers: {
    ...
    return (
        <div className='p-6'>
            ...
            <div className='flex justify-between items-center'>
                ...
                {user.role === "employee" && 
                    <Link to="/employee-dashboard/add-leave11" className='px-4 py-1 bg-custom-purple rounded text-white'>Fill New CheckSheet</Link>}
            </div>
