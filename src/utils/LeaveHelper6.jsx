...
export const LeaveButtons = ({ row }) => {
    ...
    const handleView = () => {
        navigate(`/admin-dashboard/leaves6/${row._id}`);
    };

    const handleExport = async () => {
        // Fetch the leave details to export
        const response = await fetch(`https://fatp-api.onrender.com/api/leave6/detail/${row._id}`, {
            headers: {
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
                ...
                <tbody>
                     <tr>
                            ...
                            <td style="border: 1px solid #000; padding: 8px; text-align: center;">Camera ,cylinder & fixture</td>
