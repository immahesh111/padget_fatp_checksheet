...
export const LeaveButtons = ({ row }) => {
    ...
    const handleView = () => {
        navigate(`/admin-dashboard/leaves4/${row._id}`);
    };

    const handleExport = async () => {
        // Fetch the leave details to export
        const response = await fetch(`https://fatp-api.onrender.com/api/leave4/detail/${row._id}`, {
            headers: {
...
<div style="display: flex; justify-content: space-between; margin-bottom: 20px;">
    ...
    <div style="text-align: left; margin-left: auto;"> <!-- Align text left and push div to right -->
        ...
        <p><strong>Approved By:</strong> ${row.approver || 'Not Approved Yet'}</p> <!-- Added Approver Name -->
            ...
            <h2 style="font-weight: bold; margin-top: 20px;">DAILY MAINTENANCE CHECKLIST FCT TESTER</h2>
